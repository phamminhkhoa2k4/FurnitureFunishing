...
app.controller('MyController', function ($scope) {
	...
	$scope.personalDetails = [
		{
			'pic': './asset/img/product outdoor/lollygagger-lounge-chair2.png',
			'proid': 'Outdoor Chair',
			'proname': 'Lollygagger Lounge Chair',
			'price': 645
		},
		{
			'pic': './asset/img/product outdoor/Vondom_Blow_Sofa.jpg',
			'proid': 'VONDOM',
			'proname': 'Blow Sofa',
			'price': 201
		},
		{
			'pic': './asset/img/product outdoor/umbrella.jpg',
			'proid': 'Outdoor Umbrellas',
			'proname': 'Messina Round Umbrella',
			'price': 539
		}];
	$scope.removeItem = function (a) {
		$scope.personalDetails.splice(a, 1);//delete poduction
	};
	$scope.totalmoney=0;
...
//below is the jquery date picker i found from the internet
